...
#include "Resources/KnownIdStrategy.hpp"
#include "Resources/OwnershipModels.hpp"
#include "Resources/ResourceExceptions.hpp"
...
class ResourceHolder : private sf::NonCopyable
{
	...
	public:
        ...
        /// @throw ResourceAccessException If @a id doesn't refer to a currently stored resource.
        ConstResource				get(const I& id) const;
...
#include "Resources/Detail/ResourceHolder.inl"

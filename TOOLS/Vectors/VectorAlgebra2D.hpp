...
/// @brief Check if three point is aligned
/// @tparam T Template ,type of vectors
...
/// @brief  check if two segments are intersected
/// @tparam T Template ,type of vectors
/// @param seg1A begin of segment 1
/// @param seg1B end of segment 1
/// @param seg2C begin of segment 2
/// @param seg2D end of segment 2
/// @param intersection point of intersection,if function return false it is leave unchanged
/// @return    true if have intersection ,false otherwise
template <typename T>
...
/// @brief  check if segment contain point
/// @tparam T  Template ,type of vectors
/// @param segA begin of segment
/// @param segB end of segment
/// @param pointC point to check
/// @return true if [segA,segB] contain pointC ,false otherwise
template<typename  T>
bool                segmentContainPoint(const sf::Vector2<T>& segA,
                                        const sf::Vector2<T>& segB,
                                        const sf::Vector2<T>& pointC);

/// @}

} // namespace thor

#include "Detail/VectorAlgebra2D.inl"

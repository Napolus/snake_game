...
#include "Shapes.hpp"
#include <Vectors/PolarVector2.hpp>
...
namespace Shapes
{
	...
	sf::ConvexShape roundedRect(sf::Vector2f size, float cornerRadius,const unsigned pointPerCorner)
	{
		...
		const float difference = 90.f / pointPerCorner;
